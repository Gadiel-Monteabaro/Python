...
def agregar_producto(productos, nombre, cantidad):
    ...
    productos.append({"id":id_producto, "nombre": nombre.capitalize(), "cantidad": cantidad})
...
def main():
  ...
  while True: 
    accion =  input("Desea agregar un producto (a), mostrar inventario (b), buscar producto (c), eliminar producto (d) o salir (e): ")
